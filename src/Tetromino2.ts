...
export class Tetromino2 {
    ...
    static readonly O_SHAPE = new Tetromino2(1, 1, Shape.O_SHAPE.symbol, Shape.O_SHAPE.new_orientations[0], undefined, undefined, Object.values(Shape.O_SHAPE.new_orientations));
